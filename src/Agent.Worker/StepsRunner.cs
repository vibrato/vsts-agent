            ...
            foreach (IStep step in steps)
            {
                ...
                try
                {
                    ...
                    if (!jobContext.CancellationToken.IsCancellationRequested)
                    {
                        ...
                        jobCancelRegister = jobContext.CancellationToken.Register(() =>
                        {
                            ...
                            if (HostContext.AgentShutdownToken.IsCancellationRequested)
                            {
                                ...
                                conditionReTestResult = new ConditionResult(false);
                            }
                            else
                            {
                                try
                                ...
                                catch (Exception ex)
                                {
                                    ...
                                    conditionReTestResult = new ConditionResult(false, ex.Message);
                                }
                            }
                    ...
                    if (HostContext.AgentShutdownToken.IsCancellationRequested)
                    {
                        ...
                        conditionResult = new ConditionResult(false, "Agent shutdown");
                    }
                    else
                    {
                        try
                        ...
                        catch (Exception ex)
                        {
                            ...
                            Trace.Error(ex);
                            conditionResult = new ConditionResult(false, ex.Message);
