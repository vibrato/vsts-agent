...
namespace Microsoft.VisualStudio.Services.Agent.Worker
{
    ...
    public sealed class ExpressionManager : AgentService, IExpressionManager
    {
        ...
        public ConditionResult Evaluate(IExecutionContext executionContext, IExpressionNode tree, bool hostTracingOnly = false)
        {
            ...
            result.Value = tree.EvaluateBoolean(trace: expressionTrace, secretMasker: null, state: executionContext);
            result.Trace = expressionTrace.ResultCode;
        ...
        private sealed class TraceWriter : ITraceWriter
        {
            ...
            private readonly StringBuilder _resultCodeBuilder = new StringBuilder();

            public string ResultCode => _resultCodeBuilder.ToString();
            ...
            public void Info(string message)
            {
                ...
                _resultCodeBuilder.AppendLine(message);
            }
